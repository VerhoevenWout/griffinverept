...
<div class="element hugeitmicro-item">
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/wordpress-pricing-table-builder/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../images/price-table-logo.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	<div class="right-block">
		<div class="title-block">
			<a href="http://huge-it.com/wordpress-pricing-table-builder/" target="_blank" rel="content">
				<h3>WordPress Pricing Table</h3>
			</a>
		</div>
		<div class="description-block">
			<p>Pricing Table Builder will allow you to create awesome responsive pricing tables for your site/blog. Responsive Pricing Table By Huge-IT.</p>
		</div>
		<div class="button-block">
